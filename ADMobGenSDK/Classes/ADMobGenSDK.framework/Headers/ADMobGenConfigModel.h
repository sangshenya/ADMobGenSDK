...
@property (nonatomic, copy) NSString *picflow;
...
@property (nonatomic, strong) NSArray<NSString *> *picflow;
 ...
 */
+ (instancetype)modelWithObject:(id)obj verify:(BOOL)verify;
...
/**
 ...
 @return 是否存储成功
 */
+ (BOOL)persistenceToCache:(id)obj appId:(NSString *)appId;
...
/**
 ...
 @param object 字符串
 */
+ (NSDictionary *)decryptionJsonByObj:(id)object;
