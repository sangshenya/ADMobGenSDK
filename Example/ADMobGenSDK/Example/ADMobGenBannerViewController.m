...
- (void)test2 {
    ...
    // 1 初始化banner视图
    _bannerView = [[ADMobGenBannerView alloc] initWithFrame:CGRectMake(0, 0, width, height) withBannerIndex:1 withViewController:self];
    ...
    // 3 隐藏关闭按钮，默认显示关闭按钮，目前不接管关闭按钮，无效
