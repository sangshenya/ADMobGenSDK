...
typedef enum : NSInteger {
    ...
    ADMG_SDK_RENDER_ERROR = 1005,//广告渲染失败
    ...
    //视频相关错误
    ADMG_SDK_VIDEO_INITFAIL = 5001,//初始化失败
    ADMG_SDK_VIDEO_UNKNOWN = 5002,//视频资源出现未知错误
    ADMG_SDK_VIDEO_ITEMPLAYFAIL = 5003,//视频playitem播放失败
} ADMobGenErrorCode;
