...
/**
 ...
 @param mainEdge 整体上左下右的间隙，只对left(默认:(10, 16, 10, 16))/right(默认:(10, 16, 10, 16))/three(默认:(10, 16, 10, 16))起作用,
 @param isDefult 是否使用默认间隙和背景颜色
 @param mainColor 整体背景颜色，默认为#ffffff
 @param adType 配置的信息流广告类型，目前只支持left/right/three
 */
...
/**
 ...
 @param titleColor 标题颜色，默认为#999999
 @param titleFont 标题字体大小，默认为12
 @param titlePaddingRight 标题右边距，默认为30
 @param bottomEdge 与底部间隙，默认值left、right为(0, 10, 0, 0)、three为(10, 0, 0, 0)、其他为(0, 16, 10, 16)
...
/**
 ...
 @param descColor 描述颜色，默认为#666666
 @param descFont 描述字体大小，默认为14
 @param descEdge 描述边距，normal(0, 16, 8, 16)、center(10, 16, 0, 16)、left(0, 10, 0, 0)、right(0, 10, 0, 0)、three(0, 0, 8, 0)
 @param adType 信息流广告类型
 @param isDefult 是否使用默认样式
 */
